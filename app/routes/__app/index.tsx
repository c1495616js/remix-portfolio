...
import AboutCard from '~/components/routes/about/AboutCard';
import HomeCard from '~/components/share/HomeCard';
import { experienceArray } from '~/data';
const index = () => {
  return (
    <section>
      <div className="lg:rounded-t-2xl  bg-white dark:bg-[#111111]">
        <div data-aos="fade">
          ...
          <div className="  pb-12 px-2 sm:px-5 md:px-10 lg:px-14 ">
            ...
            <div className="grid gap-8 grid-cols-1 md:grid-cols-2 xl:grid-cols-2 ">
              ...
              {experienceArray.map((item) => (
                <AboutCard key={Math.random()} item={item} local="dark" />
              ))}
            </div>
          </div>
          {/* service provide end */}
